...
import {companies} from "@/constants/contants";
    ...
    return (
        <div>
            <h1 className="text-center text-4xl uppercase leading-relaxed lg:leading-snug md:text-6xl mx-[7%]">
                Over
                <div className="bg-indigo-400 rounded-[24px] inline mx-2 p-1">
                    <Image src={arrows} alt="Arrrows" className="inline h-10 w-auto" />
                </div>
                15 years of
                full stack
                <div className="bg-amber-300 rounded-[24px] inline mx-2 p-1">
            ...
            <div className="mt-32">
                ...
                {companies.map((company, index) => (
                    <div key={index} className="flex items-center rounded-[24px] overflow-hidden w-[130px] h-[100px]">
                        <Image
                            src={company.image}
